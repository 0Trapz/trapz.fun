...
class _app {
  ...
  brandDescription = ['shittiest coder ever', 'best swipper till the fbi raids me','professional retard', 'gambling addict', 'wannabe crypto trader', 'trashtalker', 'shitposter', 'crackhead', 'full time money waster'];
