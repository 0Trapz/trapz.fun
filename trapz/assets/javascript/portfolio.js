...
$(document).ready(() => {
  ...
  for (let i in links) {
    ...
    $('#marquee').append(`<a href="https://ogu.gg/0Trapz" target="_BLANK"> « ogusers »     </a>`);
    $('#marquee').append(`<a href="https://github.com/0Trapz" target="_BLANK"> « github »     </a>`);
    $('#marquee').append(`<a href="https://dsc.bio/trapz" target="_BLANK"> « discord »     </a>`);
    $('#marquee').append(`<a href="https://open.spotify.com/user/6v5scjjnrhv0sqh5lk3zwjwjx" target="_BLANK"> « spotify »     </a>`);
    $('#marquee').append(`<a href="https://steamcommunity.com/profiles/${link.link}" target="_BLANK">${link.name}</a>`);
    $('#marquee').append(`<a href="https://ogu.gg/0Trapz" target="_BLANK"> « ogusers »     </a>`);
    $('#marquee').append(`<a href="https://github.com/0Trapz" target="_BLANK"> « github »     </a>`);
    $('#marquee').append(`<a href="https://dsc.bio/trapz" target="_BLANK"> « discord »     </a>`);
  ...
  app.titleChanger(['trapz.fun', 'Trapz on top', 'professional skid', 'best shittalker ww']);
  app.iconChanger(['assets/icons/roses/rose1.png', 'assets/icons/roses/rose2.png', 'assets/icons/roses/rose3.png', 'assets/icons/roses/rose4.png']);
});
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[trapz.fun]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from <i style='color: #0f0'>${country}</i> here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>Trapz on top! $$$</i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
